...
```powershell
.\bin\spell.exe .\Examples\Language\01-collections.kit -nologo
```
...
```powershell
.\bin\spell.exe .\Examples\Language\02-patterns.kit -nologo
```
...
```powershell
.\bin\spell.exe .\Examples\Language\03-types-and-traits.kit -nologo
```
...
```powershell
.\bin\spell.exe .\Examples\Language\04-iterators.kit -nologo
```
...
```powershell
.\bin\spell.exe .\Examples\Language\05-exceptions.kit -nologo
```
...
```powershell
.\bin\spell.exe .\Examples\Language\06-modules.kit -nologo
```
...
```powershell
.\bin\spell.exe .\Examples\Language\07-enums-and-state.kit -nologo
```
...
```powershell
.\bin\spell.exe .\Examples\Language\08-functions-and-closures.kit -nologo
```
...
```powershell
.\bin\spell.exe .\Examples\Language\09-dictionaries-and-tuples.kit -nologo
```
...
```powershell
.\bin\spell.exe .\Examples\Language\10-cleanup-and-errors.kit -nologo
```
...
```powershell
.\bin\spell.exe .\Examples\Language\11-traits-as-interfaces.kit -nologo
```
