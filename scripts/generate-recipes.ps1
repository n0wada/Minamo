...
$lines.Add("")
$lines.Add("This page contains small, complete programs that run with the Spellkit console. For a language tour, see the [overview](Overview.md); for syntax details, see the [grammar reference](../Reference/Grammar.md).")
$lines.Add("")
