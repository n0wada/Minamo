...
internal sealed partial class LoweredEmitter
{
    ...
    private void EmitBinding(LoweredBinding node, bool keepResult, CompilerContext ctx)
    {
        ...
        else
        {
            ...
            cw.JumpIfTrue(skip);
            target.ThrowError(MinamoError.MatchFailed);
            cw.Throw();
            cw.MarkLabel(skip);
            cw.NoOperation();
        }
    ...
    {
        cw.LoadType(MinamoTypeCodes.Iterator);
    ...
    private void EmitArray(LoweredArray node, bool keepResult, CompilerContext ctx)
    {
        ...
        {
            cw.LoadType(MinamoTypeCodes.Array);
            cw.LoadMember(nameof(MinamoTypeCodes.Array));
    ...
    private void EmitComprehension(LoweredComprehension node, bool keepResult, CompilerContext ctx)
    {
        ...
        {
            cw.LoadType(MinamoTypeCodes.Dictionary);
            cw.LoadMember(nameof(MinamoTypeCodes.Dictionary));
        }
        else
        {
            cw.LoadType(MinamoTypeCodes.Array);
