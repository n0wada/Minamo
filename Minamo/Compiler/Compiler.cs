...
internal sealed class MinamoCompilerEngine
{
    private readonly BuilderOptions options;
    private readonly MinamoLinker linker;
    private readonly Builder builder;

    public MinamoCompilerEngine(BuilderOptions options, MinamoLinker linker)
    {
    ...
    public MinamoCompilerEngine(MinamoCompilerEngine compiler)
    {
    ...
    public Result<Unit> Compile(MinamoCodeModel codeModel)
    {
