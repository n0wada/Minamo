...
public sealed class MinamoSelect : IDisposable
{
    ...
    public Task<MinamoSelectResult> SelectAsync(string choiceId) => session.SelectAsync(choiceId);

    /// <summary>Asynchronously executes a choice with its host-supplied argument.</summary>
    public Task<MinamoSelectResult> SelectAsync(string choiceId, object? argument) =>
        session.SelectAsync(choiceId, argument);

    /// <summary>Executes a choice from the currently published screen.</summary>
    public Task<MinamoSelectResult> SelectAsync(MinamoChoice choice)
    {
    ...
    public Task<MinamoSelectResult> SelectAsync(MinamoChoice choice, object? argument)
    {
        ArgumentNullException.ThrowIfNull(choice);
    ...
    public Task<MinamoSelectResult> SelectAtRevisionAsync(string choiceId, long revision) =>
    ...
    public Task<MinamoSelectResult> SelectAtRevisionAsync(string choiceId, object? argument, long revision) =>
    ...
    public Task<MinamoSelectResult> SendAsync(string eventId) => session.SendAsync(eventId);

    /// <summary>Asynchronously sends a host event with its host-supplied argument.</summary>
    public Task<MinamoSelectResult> SendAsync(string eventId, object? argument) =>
    ...
    public Task<MinamoSelectResult> SendAtRevisionAsync(string eventId, long revision) =>
    ...
    public Task<MinamoSelectResult> SendAtRevisionAsync(string eventId, object? argument, long revision) =>
