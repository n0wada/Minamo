global using System;
global using static Minamo.MinamoValues;
global using static Minamo.CultureInfoSettings;
...
internal static class BCL
{
    ...
    public static readonly Type MinamoObject = typeof(MinamoObject);
...
public static partial class MinamoTypeCodes
{
    ...
    internal static FastList<MinamoTypeInfo> GetAll()
    {
        var xs = new FastList<MinamoTypeInfo>();
        GetAllGenerated(xs);
        return xs;
    }
    static partial void GetAllGenerated(FastList<MinamoTypeInfo> types);
    ...
    public static MinamoTypeInfo GetMixinByCode(int code)
    {
        MinamoTypeInfo mixin = null!;
        GetMixinByCodeGenerated(code, ref mixin);
        return mixin;
    }
    static partial void GetMixinByCodeGenerated(int code, ref MinamoTypeInfo name);
...
public class MinamoValues
{
    public readonly static MinamoNil Nil = MinamoNil.Instance;
    public readonly static MinamoBool True = MinamoBool.True;
    public readonly static MinamoBool False = MinamoBool.False;
}
