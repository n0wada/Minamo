...
public class MinamoException : Exception
{
    public MinamoException(string message, Exception? innerException) : base(message, innerException) { }

    public MinamoException(string message) : base(message, null) { }
}

public class MinamoBuildException : MinamoException
{
    public IEnumerable<BuildMessage> Messages { get; }

    public MinamoBuildException(IEnumerable<BuildMessage> messages) : base("") =>
        Messages = messages;

    public MinamoBuildException(string message, Exception? innerException) : base(message, innerException) =>
...
public sealed class Result<T> : Result
{
    ...
    public T GetValueOrThrow()
    {
        if (!Success)
        {
            throw new MinamoBuildException(Messages);
        }
