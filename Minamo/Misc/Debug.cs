...
internal sealed class MinamoDebugger
{
    ...
    public MinamoDebugger(UnitComposition asm)
    {
        Composition = asm;
...
public readonly struct Par
{
    ...
    public readonly MinamoObject? Value;
    public readonly TypeAnnotation? TypeAnnotation;

    internal Par(string name, MinamoObject? val, bool isVarArg, TypeAnnotation? ta) =>
        (Name, Value, IsVarArg, TypeAnnotation) = (name, val, isVarArg, ta);

    internal Par(string name, MinamoObject? val, bool isVarArg) =>
    ...
    public Par(string name, ParKind kind, MinamoObject? value)
    {
        value ??= MinamoNil.Instance;
        (Name, Value, IsVarArg, TypeAnnotation) = (name, value, kind == ParKind.VarArg, null);
    }

    public Par(string name, MinamoObject? value)
    {
        value ??= MinamoNil.Instance;
    ...
    public Par(string name, int value) => (Name, Value, IsVarArg, TypeAnnotation) = (name, MinamoInteger.Get(value), false, null);

    public Par(string name, double value) => (Name, Value, IsVarArg, TypeAnnotation) = (name, new MinamoFloat(value), false, null);

    public Par(string name, string value) => (Name, Value, IsVarArg, TypeAnnotation) = (name, new MinamoString(value), false, null);

    public Par(string name, char value) => (Name, Value, IsVarArg, TypeAnnotation) = (name, new MinamoChar(value), false, null);
