...
public sealed class RegionSyntax : SyntaxNode
{
    ...
    public MinamoCodeModel Body { get; }

    public RegionSyntax(string name, MinamoCodeModel body, Location loc) : base(NodeType.TestBlock, loc) =>
        (Name, Body) = (name, body);
